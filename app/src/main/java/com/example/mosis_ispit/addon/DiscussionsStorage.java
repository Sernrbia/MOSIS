...
//    public ArrayList<Discussion> allDiscussions = new ArrayList<Discussion>();
...
//        this.allDiscussions = new ArrayList<Discussion>();
//        database= FirebaseDatabase.getInstance().getReference();
//        storage= FirebaseStorage.getInstance().getReference();
//        resetListeners();
//        updateAllDiscussions();
//    }
//
//    public void resetListeners(){
//        database.child(DISCUSSIONS).addListenerForSingleValueEvent(parentEventListener);
//        database.child(REQUESTS).addChildEventListener(childEventListener1);
//    }
//
//    public void updateAllDiscussions(){
//        allDiscussions.clear();
//        Query q = database.child(DISCUSSIONS).orderByChild("points");
//        q.addChildEventListener(childEventListener);
//    }
//
//    public ArrayList<User> findUsersFriends(){
//        ArrayList<User> lista = new ArrayList<>();
//        for(int i=0;i<allDiscussions.size();i++){
//            if(currUser.friends.containsValue(allDiscussions.get(i).UID)){
//                lista.add(allDiscussions.get(i));
//            }
//        }
//        usersFriends = lista;
